...
> This is a course on the [Program in Data Science, Statistics and Decision Analysis]
>
...
The course makes heavy use of interactive Observable notebooks in javascript that runs in your browser. The widgets will be linked below each relevant lecture. All widgets used in the course are available [here](http://localhost:8000).
